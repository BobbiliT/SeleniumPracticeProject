...
public class FindBrokenLinksFromGoibibo {
	public static void main(String[] args) throws Exception {
		...
		System.out.println("size of the all active links :"+activelinks.size());
		driver.quit();
	}
	public static void checkbrkoen(String linkurl) throws Exception {
		try {
